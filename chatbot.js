(function () {
  const SHEET_URL = "https://script.google.com/macros/s/AKfycbwRKZNyPiiuGpAHZcBIjzNuQari_nxxOBOXgdfD6f2fMTZPUESrIhx2GMrYdgMAY93u/exec";
  ...
  const FAQ = {
    ...
    register: {
      ...
      link: "Register Now →",
      url: "https://meica-expo.com/register"
    },
  ...
  function handleInput(text) {
    ...
    setTimeout(() => {
      ...
      if (t.match(/^(hi|hello|hey|greetings)/)) {
        ...
        addBot("You're welcome! 😊 See you at MEICA EXPO 2026 in Kuwait!", MAIN_QRS);
      } else if (t.includes('bye') || t.includes('goodbye')) {
        addBot("Goodbye! 👋 See you at MEICA EXPO 2026 in Kuwait. Feel free to come back anytime!", []);
      } else {
        addBot("I'm here to help with MEICA EXPO 2026. Please choose a topic below:", MAIN_QRS);
      }
    }, 700);
  }
