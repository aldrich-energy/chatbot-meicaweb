(function () {
  ...
  const NOTIFICATION_API = "https://aldrich-energy.vercel.app/api/meica-email-notification"; 
  ...
  async function submitEmail() {
    ...
    setTimeout(() => {
      removeTyping();
      addBot("🎉 Thank you! Your email has been saved.\n\nWe'll keep you updated on MEICA EXPO 2026 in Kuwait. How can I help you today?", MAIN_QRS);
    }, 800);
  }
